    ...
    schema.eachPath(function(value, key) {
      ...
      if (typeof struct[key] === 'undefined' && options.omitUndefined === true) {
        ...
        if (typeof value.validator !== 'undefined' &&
          ...
          typeof struct[key] !== 'undefined') {
          var found = false;
          if (Object.prototype.toString.call(struct[key]) === '[object Array]') {
            var l = value.validator.length;
            var t = _.union(struct[key], value.validator).length;
            if (t === l) {
              found = true;
            }
          } else {
            found = _.contains(value.validator, struct[key]);
          }
          if (!found) {
            struct[key] = found;
          }
